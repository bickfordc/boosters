$(function () {
    $("#list").jqGrid({
        ...
        datatype: "xml",
        mtype: "GET",
        colNames: ["Family First", "Family Last", "Family Active", "Notes", "Student First", "Student Middle", "Student Last"],
        colModel: [
            { name: "family_first", width: 60, editable: true },
            { name: "family_last", width: 60, editable: true },
