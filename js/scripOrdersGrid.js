$(function () {
    $("#list").jqGrid({
        ...
        datatype: "xml",
        mtype: "GET",
        colNames: ["Order Date", "Order ID", "Family First", "Family Last", "Amount", "Rebate", "Student First", "Middle", "Student Last"],
        colModel: [
            ...
            { name: "order_amount", width: 40,  align: "right", searchoptions:{sopt: ['eq','lt','le','gt','ge']}},
