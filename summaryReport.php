...
require_once 'report/SummaryReport.php';
...
if ($gatheredRequirements == false) {
  echo <<<_END
    ...
    <div class='form'>
      <form method='post' action='summaryReport.php' autocomplete='off'>$error
        ...
        <button>Run summary report</button>
      </form>
    </div>
_END;
} 
...
//      "});" .
//    "</script>";
    $report = new SummaryReport($startDate, $endDate);
